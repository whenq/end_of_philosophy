...
the reading order are as follows:

being: the bare sense of Being, that philosophy have been stuck with since the very start, this is the ultimate veil
...
the 'understanding' text is an old one

the 'problems' series are also old but they are advance and can only be read after the main texts
